...
void async function main () {
  ...
  for (const draft of messages.drafts) {
    await pronote.discussionRemoveDraft(session, discussion, draft);
    console.log("Draft deleted:", draft.content);
  }

  console.log("Remaining", discussion.numberOfDrafts, "draft(s) !");
}();
