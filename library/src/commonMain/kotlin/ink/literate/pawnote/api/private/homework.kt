...
suspend fun homeworkFromWeek(
  ...
  val request =
      RequestFN(
          ...
          Json.encodeToString(
              buildJsonObject {
                putJsonObject("_Signature_") { put("onglet", tab.code) }
                ...
                putJsonObject("donnees") {
                  putJsonObject("domaine") {
                    ...
                    put(
                        "V",
                        if (extendsToWeekNumber != null) "[$weekNumber..$extendsToWeekNumber]"
                        else "[$weekNumber]")
                  }
                }
              }))
...
suspend fun homeworkFromIntervals(
