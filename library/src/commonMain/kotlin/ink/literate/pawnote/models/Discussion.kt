...
class Discussion(
    ...
    /**
     * Output is very variable, see example below. Because of this behavior, we can't transform this
     * into a date.
     *
     * Maybe, we could parse this manually, but it's not a priority.
     *
     * @example "lundi 08h53" // or can just be the hour "07h26"
     */
    val dateAsFrenchText: String,

    /**
     * Internal string containing the ID of the message needed to fetch the participants of the
     * discussion.
     */
    val participantsMessageID: String,

    /**
     * Property used internally to manage messages in this discussion in requests.
     *
