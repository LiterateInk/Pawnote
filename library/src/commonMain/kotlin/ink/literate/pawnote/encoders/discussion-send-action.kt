...
fun encodeDiscussionSendAction(
    action: DiscussionSendAction,
    includeParentsAndStudents: Boolean
): DiscussionSendAction {
  var actionToSend: DiscussionSendAction = action

  if (action == DiscussionSendAction.SendEveryoneExceptParentsAndStudents &&
      includeParentsAndStudents)
      actionToSend = DiscussionSendAction.SendEveryone

  if (action == DiscussionSendAction.ReplyEveryoneExceptParentsAndStudents &&
      includeParentsAndStudents)
