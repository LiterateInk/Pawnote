...
/**
 * Fetches the messages and writes them in the discussion. By default it won't mark the messages as
 * read even after fetching them.
 *
 * You can change this behavior by setting `markAsRead` to `true`. There's no other way to mark the
 * messages as read.
 *
 * @param markAsRead Whether to mark the messages as read after fetching them.
 */
suspend fun discussionMessages(
