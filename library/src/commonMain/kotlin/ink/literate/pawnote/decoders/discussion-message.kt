...
fun <T> decodeDiscussionMessage(
  ...
  return DiscussionMessage(
      ...
      content =
          if (message["estHTML"]?.jsonPrimitive?.boolean == true)
              message["contenu"]!!.jsonObject["V"]!!.jsonPrimitive.content
          else message["contenu"]!!.jsonPrimitive.content,
      ...
      files =
          if (message["listeDocumentsJoints"] != null)
              message["listeDocumentsJoints"]!!.jsonObject["V"]!!.jsonArray.map {
