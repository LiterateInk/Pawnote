...
import ink.literate.pawnote.models.NotebookPunishment
import ink.literate.pawnote.models.SessionHandle
import kotlinx.serialization.json.*

fun decodeNotebookPunishment(punishment: JsonObject, session: SessionHandle) =
    NotebookPunishment(
        id = punishment["N"]!!.jsonPrimitive.content,
        title = punishment["nature"]!!.jsonObject["V"]!!.jsonObject["L"]!!.jsonPrimitive.content,
        reasons =
            punishment["listeMotifs"]!!.jsonObject["V"]!!.jsonArray.map {
        ...
        workToDoDocuments =
            punishment["documentsTAF"]!!.jsonObject["V"]!!.jsonArray.map {
        ...
        circumstancesDocuments =
            punishment["documentsCirconstances"]!!.jsonObject["V"]!!.jsonArray.map {
              decodeAttachment(it.jsonObject, session.information)
            },
        giver = punishment["demandeur"]!!.jsonObject["V"]!!.jsonObject["L"]!!.jsonPrimitive.content,
        dateGiven =
            decodePronoteDate(punishment["dateDemande"]!!.jsonObject["V"]!!.jsonPrimitive.content),
