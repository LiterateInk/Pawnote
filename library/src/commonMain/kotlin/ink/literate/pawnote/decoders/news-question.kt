...
fun decodeNewsQuestion(question: JsonObject, sessionInformation: SessionInformation): NewsQuestion {
  val kind: NewsQuestionKind =
      NewsQuestionKind.fromInt(question["genreReponse"]!!.jsonPrimitive.int)
  val answered =
      question["reponse"]!!.jsonObject["V"]!!.jsonObject["avecReponse"]!!.jsonPrimitive.boolean
  ...
  return NewsQuestion(
      ...
      attachments =
          question["listePiecesJointes"]!!.jsonObject["V"]!!.jsonArray.map {
      ...
      shouldAnswer =
          question["reponse"]!!
              .jsonObject["V"]!!
              .jsonObject["estReponseAttendue"]!!
              .jsonPrimitive
              .boolean,
      answerDate =
          if (question["reponse"]!!.jsonObject["V"]!!.jsonObject["reponduLe"] != null)
              decodePronoteDate(
                  question["reponse"]!!
                      .jsonObject["V"]!!
                      .jsonObject["reponduLe"]!!
                      .jsonObject["V"]!!
                      .jsonPrimitive
                      .content)
          else null,
      choices =
          if (kind == NewsQuestionKind.TextInput) listOf()
          else
              question["listeChoix"]!!.jsonObject["V"]!!.jsonArray.map {
                decodeNewsQuestionChoice(it.jsonObject)
              },
