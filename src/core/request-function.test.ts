...
describe("RequestFN", () => {
  test("URLs", () => {
    ...
    expect(request.url.href).toBe(SESSION_BASE + "/appelfonction/6/" + SESSION_ID + "/3fa959b13967e0ef176069e01e23c8d7");
    ...
    expect(request.url.href).toBe(SESSION_BASE + "/appelfonction/6/" + SESSION_ID + "/7c1f9564ba825ab3d87d6dc965105db7");
  });
