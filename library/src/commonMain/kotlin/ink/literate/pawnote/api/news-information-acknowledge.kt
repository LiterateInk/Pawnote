 ...
 * (`!needToAcknowledge`) or is already `acknowledged`, we will just do the read step.
 *
 * When acknowledging, the news will be directly marked as read. If you want to change this
 * behavior, you can change the `alsoMarkAsRead` parameter.
 *
...
suspend fun newsInformationAcknowledge(
  ...
  if (information.data !is NewsInformation) throw NewsTypeError("NewsInformation")
  ...
  if (alsoMarkAsRead) information.read = true
}
