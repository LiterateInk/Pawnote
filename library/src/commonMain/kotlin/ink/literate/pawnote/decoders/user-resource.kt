...
fun decodeUserResource(
  ...
  if (resource["listeOngletsPourPeriodes"] != null)
      for (tab in
          resource["listeOngletsPourPeriodes"]!!.jsonObject["V"]?.jsonArray
              ?: listOf()) if (TabLocation.fromInt(tab.jsonObject["G"]!!.jsonPrimitive.int) != null)
  ...
  return UserResource(
      ...
      establishmentName =
          resource["Etablissement"]!!.jsonObject["V"]!!.jsonObject["L"]!!.jsonPrimitive.content,
      className =
          if (resource["classeDEleve"] != null)
              resource["classeDEleve"]!!.jsonObject["L"]!!.jsonPrimitive.content
          else null,
