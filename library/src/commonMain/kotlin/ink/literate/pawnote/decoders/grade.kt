...
import ink.literate.pawnote.models.Grade
...
fun decodeGrade(grade: JsonObject, sessionInformation: SessionInformation): Grade {
  ...
  return Grade(
      ...
      defaultOutOf =
          decodeGradeValue(grade["baremeParDefaut"]!!.jsonObject["V"]!!.jsonPrimitive.content),
      ...
      average =
          if (grade["moyenne"] != null)
              decodeGradeValue(grade["moyenne"]!!.jsonObject["V"]!!.jsonPrimitive.content)
          else null,
