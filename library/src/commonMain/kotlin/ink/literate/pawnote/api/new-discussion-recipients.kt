...
suspend fun newDiscussionRecipients (
    ...
    val request = RequestFN(session.information, "ListeRessourcesPourCommunication", Json.encodeToString(
        buildJsonObject {
    ...
    return Json.parseToJsonElement(response.data).jsonObject["donnees"]!!.jsonObject["listeRessourcesPourCommunication"]!!.jsonObject["V"]!!.jsonArray
