...
class RequestFNTest {
  ...
  fun `test URLs`() {
    ...
    assertEquals(
        sessionBase + "/appelfonction/6/" + sessionId + "/3fa959b13967e0ef176069e01e23c8d7",
    ...
    assertEquals(
        sessionBase + "/appelfonction/6/" + sessionId + "/7c1f9564ba825ab3d87d6dc965105db7",
        request.process().url.toString())
  }
  ...
  fun `should compress only`() {
    ...
    assertEquals(
        "358ed1118030084357d220891d47dbbaff08869e1e5f798f0be80678f0e1f4245301c4a5a253c94198a158301afac7bba7297896f9c9b270d7e394dc3957d721d86759d1b4af64e36d7760e38e4d517b6cfec2e734345e",
        request.data)
  }
  ...
  fun `should encrypt only`() {
    ...
    assertEquals(
        "4c859cd38ec673c7466130ca9b064bf7116950339c5f11b7c30b1d72191a7b29d60fc44c2a9c19751979ccb12785cd9d8178356f4d1a4a3c8e2172b90f795e1b5fff0003042ea2d790028021ce3f0666",
        request.data)
  }
  ...
  fun `should compress and encrypt`() {
    ...
    assertEquals(
        "ab7a186a6a76ea9e78a65a0930c001cfd112c8b36da16b0bd6817295c83d1e48396c4ec34955ae8142270519dcd631019e214af5cb135fa961ea0cefdd833afd04c25b0b3a9b6cccf6c2dbad7f5904edec3a2b095952cf8513e9a35ae6e1b7fe",
        request.data)
    ...
    assertEquals(
        "fc5edbd03c4b614c467e8da07008071c575b433aeba4d519c7885f567b68356335c998842d1ba65a687e705618f4d1bfc5f9165a46fc84f0c98a21380478bbbad607cca5fc7111388f237487bc6bea120d347e555b9a990c19f096de38bdab01",
        request.data)
  }
}
