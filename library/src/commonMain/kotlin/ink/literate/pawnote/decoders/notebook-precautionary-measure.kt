...
fun decodeNotebookPrecautionaryMeasure(item: JsonObject, session: SessionHandle) =
    NotebookPrecautionaryMeasure(
        ...
        reasons =
            item["listeMotifs"]!!.jsonObject["V"]!!.jsonArray.map {
        ...
        circumstancesDocuments =
            item["documentsCirconstances"]!!.jsonObject["V"]!!.jsonArray.map {
              decodeAttachment(it.jsonObject, session.information)
            },
        decisionMaker =
            item["decideur"]!!.jsonObject["V"]!!.jsonObject["L"]!!.jsonPrimitive.content,
        giver = item["demandeur"]!!.jsonObject["V"]!!.jsonObject["L"]!!.jsonPrimitive.content,
        dateGiven =
            decodePronoteDate(item["dateDemande"]!!.jsonObject["V"]!!.jsonPrimitive.content),
        ...
        disallowedAccesses =
            decodeDomain(item["interditAcces"]!!.jsonObject["V"]!!.jsonPrimitive.content).map {
              AccessKind.fromInt(it)
            })
